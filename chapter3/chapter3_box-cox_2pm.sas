...
array predvalue[1000] pred1-pred1000;
	...
	* Generate normal random number to approximate the expectation of \mu ^ (1/gamma);
	do i=1 to 1000;
		...
		predvalue[i]= p*normalvalue[i]**(1/&gamma);
	end;
...
/* Box-Cox Transformations Model results: 
   Mean residual: -725.63664			
   Mean absolute residual: 6036.606*/
...
/* Box-Cox Model results: 
   Mean cross-validation residual: -174.51094	
   Mean cross-validation absolute residual: 5492.33035 */
...
proc export data=bootstrap_parameter
	     outfile="/Users/lexy/Library/CloudStorage/OneDrive-WashingtonUniversityinSt.Louis/Desktop/202409_MEPS/05_GitHub/chapter3/bootstrap_parameter.csv"
	     dbms=csv replace;
run;
...
/*proc export data=bootstrap_stats
	     outfile="/Users/lexy/Library/CloudStorage/OneDrive-WashingtonUniversityinSt.Louis/Desktop/202409_MEPS/05_GitHub/chapter3/bootstrap_stats.csv"
	     dbms=csv replace;
run;*/
