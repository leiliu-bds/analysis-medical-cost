...
proc nlmixed data=&data NOSORTSUB;
	...
	*for zero-cost;
	...
	/* NOTE: To calculate the incremental effect, please refer to "chapter4_r2pm_generalized-gamma_rate_of_change.R". */	
 	/*
 	*Marginal Effects;
...
%MACRO gamma_model(fold,pred);
	...
	title "Generalized Gamma distribution on correlated cost data (training data excluding fold &fold.)";
	proc nlmixed data=train NOSORTSUB;
...
/* Generalized Gamma Model results: 
   Mean cross-validation residual: 123.6
   Mean cross-validation absolute residual: 5454.1 */
